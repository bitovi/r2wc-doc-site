      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Complete Example', slug: 'get-started/complete-example' },
            { label: 'Programmatic Usage', slug: 'get-started/programatic-usage' },
          ],
        },
        {
          label: 'API',
          items: [
            ...
            { label: 'Basic API', slug: 'api/api' },
            { label: 'Typed Props', slug: 'api/props/typed-props' },
            { label: 'Function Props', slug: 'api/props/function-props' },
            { label: 'Method Props', slug: 'api/props/method-props' },
          ],
        },
        {
          label: 'Guides',
